...
function NotFound() {
  return (
    <div className="grid-light bg-paper px-4 py-28 text-center">
      ...
      <p className="mx-auto mt-5 max-w-md text-smoke">
        This page is not in the {business.name} site map. The catalogue, rental fleet and services are one click away.
      </p>
      <div className="mt-8 flex justify-center gap-3">
        <CTAButton to="/" variant="dark">
          Back to home
        </CTAButton>
        <CTAButton to="/products" variant="safety">
          Browse products
        </CTAButton>
      </div>
      <p className="mt-10 font-mono text-[11px] uppercase tracking-[0.16em] text-smoke">
        Lost? <Link to="/contact" className="text-safety underline-offset-4 hover:underline">Contact us</Link>
      </p>
    </div>
  );
}
